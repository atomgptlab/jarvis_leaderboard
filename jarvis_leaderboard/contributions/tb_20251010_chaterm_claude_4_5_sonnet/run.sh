#!/bin/bash
# This entry is NOT our measurement. It is Chaterm + claude-4-5-sonnet's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/20251010_Chaterm_claude-4-5-sonnet
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/20251010_Chaterm_claude-4-5-sonnet
