#!/bin/bash
# This entry is NOT our measurement. It is droid + gpt-5's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/20250924_droid_gpt-5
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/20250924_droid_gpt-5
