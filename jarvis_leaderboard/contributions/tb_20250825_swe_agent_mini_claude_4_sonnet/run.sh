#!/bin/bash
# This entry is NOT our measurement. It is swe-agent-mini + claude-4-sonnet's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/20250825_swe-agent-mini_claude-4-sonnet
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/20250825_swe-agent-mini_claude-4-sonnet
