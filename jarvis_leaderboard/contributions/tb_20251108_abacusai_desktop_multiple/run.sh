#!/bin/bash
# This entry is NOT our measurement. It is abacusai-desktop + multiple's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/20251108_abacusai-desktop_multiple
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/20251108_abacusai-desktop_multiple
