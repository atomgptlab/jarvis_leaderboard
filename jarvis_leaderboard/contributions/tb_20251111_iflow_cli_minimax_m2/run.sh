#!/bin/bash
# This entry is NOT our measurement. It is iflow-cli + Minimax-M2's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/20251111_iflow-cli_Minimax-M2
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/20251111_iflow-cli_Minimax-M2
