#!/bin/bash
# This entry is NOT our measurement. It is droid + claude-4-1-opus's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/20250923_droid_claude-4-1-opus
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/20250923_droid_claude-4-1-opus
