#!/bin/bash
# CHIPS-FF (dft_3d_chipsff) entries for the ALIGNN-FF JARVIS-FF-FD force field.
...
MODEL=${MODEL:-/home/kamalch/alignn2026/fd_ev_upload}
D=${D:-/home/kamalch/alignn2026/chipsff_alignn_ff_jarvis_ff_fd}                 # work dir: lb_jids.json + chemical_potentials.json
...
A=../alignn2_radius
"$PY" "$HERE/$A/chipsff_extract_pred.py" "$D" "$HERE/chipsff_pred_jarvis_ff_fd.json" full
...
#   $A/build_matpes_unary.py  (retargeted at $MODEL)  -> jarvis_ff_fd_unary.json
