#!/bin/bash
# This entry is NOT our measurement. It is ob1-09-10-25's own
...
# leaderboard:
#
#   https://github.com/laude-institute/terminal-bench-leaderboard/tree/main/results/terminal-bench-core%400.1.1/ob1-09-10-25
#
...
cd terminal-bench-leaderboard/results/terminal-bench-core@0.1.1/ob1-09-10-25
